About pywebhdfs-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pywebhdfs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5391&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pywebhdfs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pywebhdfs` can be installed with `conda`:
...
```
mamba install pywebhdfs
```

It is possible to list all of the versions of `pywebhdfs` available on your platform with `conda`:
...
```
mamba search pywebhdfs --channel conda-forge
```
...
mamba repoquery search pywebhdfs --channel conda-forge

# List packages depending on `pywebhdfs`:
mamba repoquery whoneeds pywebhdfs --channel conda-forge

# List dependencies of `pywebhdfs`:
mamba repoquery depends pywebhdfs --channel conda-forge
```
